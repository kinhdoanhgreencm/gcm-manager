...
CREATE TABLE IF NOT EXISTS users (
  ...
  phone TEXT,
  role TEXT NOT NULL DEFAULT 'SALES' CHECK (role IN ('MANAGER', 'SALES', 'ACCOUNTANT', 'INVENTORY', 'LEGAL')),
...
COMMENT ON COLUMN users.role IS 'Vai trò: MANAGER (Quản lý), SALES (Kinh doanh), ACCOUNTANT (Kế toán), INVENTORY (Kho), LEGAL (Hồ sơ)';
